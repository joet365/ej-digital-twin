...
const LexiDiscoveryCTASection = () => {
  ...
  return (
    <section id="discovery-call" className="py-24 gradient-cta-lexi relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
              Ready to <span className="text-gradient-lexi">Amplify</span> Your Marketing?
            </h2>
            <p className="text-xl text-white/80 max-w-2xl mx-auto">
              Schedule a free 30-minute discovery call to see how Lexi can transform your brand presence
            </p>
          </motion.div>
              ...
              <form onSubmit={handleSubmit} className="p-8 rounded-3xl bg-white/10 backdrop-blur-md border border-white/20">
                <div className="grid md:grid-cols-2 gap-6 mb-6">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="bg-white/10 border-white/20 text-white placeholder:text-white/40 focus:border-pink-500"
                    />
                ...
                <div className="space-y-2 mb-8">
                  <Label htmlFor="message" className="text-white">
                    Tell us about your marketing goals <span className="text-white/50">(optional)</span>
                  </Label>
                  <Textarea
                    id="message"
                    name="message"
                    ...
                    onChange={handleChange}
                    placeholder="What marketing channels are you focused on? What are your biggest content challenges?"
                    rows={4}
                    className="bg-white/10 border-white/20 text-white placeholder:text-white/40 focus:border-pink-500 resize-none"
                  />
                </div>
                ...
                <div className="text-center">
                  <Button
                    type="submit"
                    size="xl"
                    className="bg-pink-500 hover:bg-pink-600 text-white glow-pink group w-full sm:w-auto"
                  ...
                  <p className="text-white/50 text-sm mt-4">
                    No commitment required. We'll discuss your needs and show you how Lexi can help.
                  </p>
                </div>
              </form>
            )}
...
export default LexiDiscoveryCTASection;
